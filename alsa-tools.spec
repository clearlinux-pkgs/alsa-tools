...
Version  : 1.2.2
Release  : 2
URL      : https://github.com/alsa-project/alsa-tools/archive/v1.2.2.tar.gz
Source0  : https://github.com/alsa-project/alsa-tools/archive/v1.2.2.tar.gz
...
%prep
%setup -q -n alsa-tools-1.2.2
cd %{_builddir}/alsa-tools-1.2.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588293857
...
cp %{_builddir}/alsa-tools-1.2.2/as10k1/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/9db6e6f4189b7101178eef598c9985910e51456d
cp %{_builddir}/alsa-tools-1.2.2/echomixer/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/alsa-tools-1.2.2/envy24control/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/alsa-tools-1.2.2/hdspconf/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/alsa-tools-1.2.2/hdsploader/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/alsa-tools-1.2.2/hdspmixer/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/alsa-tools-1.2.2/ld10k1/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/alsa-tools-1.2.2/ld10k1/COPYING.LIB %{buildroot}/usr/share/package-licenses/alsa-tools/597bf5f9c0904bd6c48ac3a3527685818d11246d
cp %{_builddir}/alsa-tools-1.2.2/qlo10k1/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/alsa-tools-1.2.2/rmedigicontrol/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/alsa-tools-1.2.2/sb16_csp/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/alsa-tools-1.2.2/seq/sbiload/COPYING %{buildroot}/usr/share/package-licenses/alsa-tools/133efad5329acf364135c569ac01ec084c3d4647
%make_install
