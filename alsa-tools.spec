...
Version  : 1.2.14
Release  : 8
URL      : https://www.alsa-project.org/files/pub/tools/alsa-tools-1.2.14.tar.bz2
Source0  : https://www.alsa-project.org/files/pub/tools/alsa-tools-1.2.14.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/tools/alsa-tools-1.2.14.tar.bz2.sig
...
%setup -q -n alsa-tools-1.2.14
cd %{_builddir}/alsa-tools-1.2.14
%patch -P 1 -p1
pushd ..
cp -a alsa-tools-1.2.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744725901
